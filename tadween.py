...
section.orientation = WD_ORIENT.LANDSCAPE  # Optional for horizontal A3
...
for i in range(1, image_count + 1):
    ...
    run.add_picture(image_path, width=Inches(3), height=Inches(4))

# Save the document
doc.save("E:\\MadinaPages\\output_document.docx")
