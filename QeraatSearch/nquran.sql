...
#ملخص ما تم حذفه
SELECT distinct reading FROM quran_data_original
WHERE (aya_index, id) NOT IN (SELECT aya_index, id FROM quran_data);
...
-- قرؤوا بفتح هاء التأنيث.
-- قرؤوا بقصر مد البدل.
-- قرؤوا بتحقيق الهمزة المتطرفة وصلاً ووقفا.
-- قرؤوا بقصر مد البدل مع تحقيق الهمزة.
-- قرؤوا بترك السكت، وإسكان ميم الجمع وصلاً ووقفا.
-- قرؤوا بقصر مد البدل، وبترك السكت مع تحقيق الهمزة وصلاً ووقفا.
-- قرؤوا بترك السكت، وإسكان ميم الجمع، مع قصر مد البدل.
-- قرؤوا بقصر مد البدل، مع فتح هاء التأنيث.
-- قرؤوا بتحقيق الهمزتين وصلاً ووقفا.
-- قرؤوا بتحقيق الهمزة، وترك السكت، مع قصر مد اللين.
-- قرؤوا بقصر مد البدل، وترك السكت مع تحقيق الهمزة وصلاً ووقفا.
-- قرؤوا بترك السكت، مع تفخيم الراء، وقصر مد البدل، وفتح هاء التأنيث.
-- قرؤوا بتفخيم الراء في الحالين.
-- قرؤوا بقصر مد البدل، مع تحقيق الهمزة، وفتح هاء التأنيث.
-- قرؤوا بتحقيق الهمزة، مع ترك السكت وصلاً ووقفا.
-- قرؤوا بقصر مد البدل مع ترك هاء السكت.

SELECT Distinct qd.reading AS new_reading, qdo.reading AS original_reading
FROM quran_data qd
