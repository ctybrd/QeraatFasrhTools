...
FROM (
    SELECT 
        ...
        END as csub_subject,
         reading as creading,
        ifnull(readingresult, '') as readingresult,qarees,
...
GROUP BY page_number2, creading, readingresult,qarees
...
for page_number2 in range(1, 523):  # Assuming you have 522 pages
    ...
    doc.add_paragraph(f"صفحة : {page_number2}", style='Heading1').alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
