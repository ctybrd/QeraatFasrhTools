...
# Copy data_v19.db from the source folder to the current folder
source_db_path = r'd:/Qeraat/Wursha_QuranHolder/other/data/data_v19.db'
destination_db_path = './data_v19.db'
...
# Function to create a new table in the data_v19.db database and insert data into it
...
conn_data_v19 = sqlite3.connect('./data_v19.db')
...
for setting in settings:
    ...
    if result:
      create_and_insert_table(conn_data_v19, table_name, columns, result)
    else:
