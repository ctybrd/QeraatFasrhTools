...
original_images_dir = "E:\Qeraat\QeraatFasrhTools_Data\ShmrlySides\side1"

# Path to the directory containing the side column images
side_column_images_dir = "E:\Qeraat\QeraatFasrhTools_Data\ShmrlySides\SideE"
...
for image_file in original_images_files:
    ...
    if original_image is not None and side_column_image is not None:
        ...
        new_width =int(original_image.width * 4 / 5)
        new_height = original_image.height
        resized_original_image = original_image 
        #.resize((new_width, new_height))

        # Resize the side column image to be 1/5 of the original image width
        side_width = int(original_image.width / 5)
        ...
        combined_width = resized_original_image.width + resized_side_column_image.width + 4
        ...
        combined_image.paste(resized_side_column_image, (resized_original_image.width + 4, 0))
